 ...
 * </p>
 * <p>
 * Description: 提供给用户进行点播相关操作的视频云客户端
 * </p>
 * <p>
 * Company: newNet
 * </p>
...
public class VcloudClient {
	 ...
	 * 
	 * <p>
	 * Description: 传入访问服务的凭据类和客户端配置类构造视频云客户端
	 * </p>
	 * 
	 * @param credentials
	 *            传入访问服务的凭据类
	 ...
	 *            客户端配置类
	 */
	public VcloudClient(Credentials credentials, ClientConfiguration clientConfiguration) {
	 ...
	 * 
	 * <p>
	 * Description: 传入访问服务的凭据类构造视频云客户端，客户端配置会采用默认配置
	 * </p>
	 * 
	 * @param credentials
	 *            传入访问服务的凭据类
	 ...
	 * @throws IOException
	 */
	public InitUploadVideoParam initUploadVideo(String originFileName, String userFileName, Long typeId, Long presetId,
			String callbackUrl, String description, Long watermarkId) throws IOException, VcloudException {
	 ...
	 * @throws VcloudException
	 */
	public UploadVideoFragmentParam uploadVideoFragment(String bucket, String uploadHost, String object, Long offset,
			String context, InputStream in, Long remainderSize, String xNosToken) throws VcloudException, IOException {
		UploadVideoFragmentService uploadVideoFragmentService = new UploadVideoFragmentServiceImpl();
		return uploadVideoFragmentService.uploadVideo(bucket, uploadHost, object, offset, context, in, remainderSize,
				xNosToken);
	}
	...
	public UploadVideoFragmentParam uploadVideoFragment(InitUploadVideoParam initUploadVideoParam,
			GetUploadHostParam getUploadHostParam, Long offset, String context, InputStream in, Long remainderSize)
					throws VcloudException, IOException {
		UploadVideoFragmentService uploadVideoFragmentService = new UploadVideoFragmentServiceImpl();
		return uploadVideoFragmentService.uploadVideo(initUploadVideoParam, getUploadHostParam, offset, context, in,
				remainderSize);
	}
	 ...
	 * @throws VcloudException
	 */
	public QueryOffsetParam getPartOffset(String uploadHost, String bucket, String object, String context,
			String xNosToken) throws IOException, VcloudException {
	 ...
	 * @param getUploadHostParam
	 *            获取上传加速节点地址返回结果的封装类
	 * @param uploadVideoParam
	 *            分片上传视频返回结果的封装类
	 */
	public QueryOffsetParam getPartOffset(InitUploadVideoParam initUploadVideoParam,
			GetUploadHostParam getUploadHostParam, UploadVideoFragmentParam uploadVideoParam)
					throws IOException, VcloudException {
	 ...
	 * @throws IOException
	 */
	public QueryVideoIDorWatermarkIDParam uploadVideo(String filePath, Map<String, Object> initParamMap)
			throws IOException, VcloudException {
	 ...
	 * @throws IOException
	 */
	public QueryVideoIDorWatermarkIDParam uploadVideo(String filePath, String originFileName, String userFileName,
			Long typeId, Long presetId, String callbackUrl, String description, Long watermarkId)
					throws IOException, VcloudException {
	...
	public String deleteVideo(int vid, int style) throws IOException, VcloudException {

		Map<String, Object> initParamMap = new HashMap<String, Object>();
		initParamMap.put("vid", vid);
		initParamMap.put("style", style);
		UploadVideoService UploadVideoService = new UploadVideoServiceImpl();
		return UploadVideoService.deleteVideo(initParamMap);
